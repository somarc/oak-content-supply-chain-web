    ...
    <section class="ocs-card ocs-operator-card">
      ...
      <div class="ocs-dev-grid">
        <label>${cfg.walletLabel || 'Wallet Override'}
          <input data-ocs-el="wallet" value="0x742d35Cc6634c0532925a3b844bc9e7595f0beb" />
        </label>
        <label>${cfg.orgLabel || 'Organization'}
          <input data-ocs-el="org" value="example-org" />
        </label>
        <label>${cfg.validatorUrlLabel || 'Validator URL'}
          <input data-ocs-el="validatorUrl" value="http://127.0.0.1:8787/ops/v1/content-chain/validator" />
        </label>
        <label>${cfg.normalizerUrlLabel || 'Normalizer API URL'}
          <input data-ocs-el="normalizerUrl" value="http://127.0.0.1:8088" />
        </label>
        <label>${cfg.paymentRecipientLabel || 'Payment Recipient Override'}
          <input data-ocs-el="paymentRecipientOverride" placeholder="optional 0x..." />
        </label>
        <label>${cfg.ipfsModeLabel || 'IPFS Mode'}
          <select data-ocs-el="ipfsMode">
        ...
        <label>${cfg.clientCidLabel || 'Client CID (if client mode)'}
          <input data-ocs-el="clientIpfsCid" placeholder="Qm... or bafy..." />
        </label>
      </div>
